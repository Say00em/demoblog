...
<link rel="stylesheet" href="{{asset('dashboard_assets/css/color_skins.css')}}">
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="{{asset('dashboard_assets/images/logo.svg')}}" width="48" height="48" alt="Alpino"></div>
        <p>Please wait...</p>        
    </div>
</div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="social">
                    ...
                    <p>Coded by WrapTheme<br> Designed by <a href="http://thememakker.com/" target="_blank">thememakker.com</a><br> Developed by <a href="https://github.com/say00em" target="_blank">Say3m</a></p>
                </div>
            </div>
        </div>
    </div>
...
<aside id="minileftbar" class="minileftbar">
    <ul class="menu_list">
        <li>
            ...
            <a class="navbar-brand" href="index.html"><img src="{{asset('dashboard_assets/images/logo.svg')}}" alt="Alpino"></a>
        </li>
        ...
        <li><a href="{{ route('message.notification') }}" title="Inbox"><i class="zmdi zmdi-email"></i></a></li>
            ...
            <div class="card">
                ...
                <div class="body">
                    <ul class="messages list-unstyled">
                        ...
                        <li>
                            <a href="{{ route('message.notification') }}">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('dashboard_assets/images/xs/avatar1.jpg')}}" alt="">
                                    <div class="media-body">
                                        <span class="name">{{ $notification->cont_name }} <small class="time">35min ago</small></span>
                                        <p class="message">{{ $notification->cont_message }}</p>                                        
                                    </div>
                                </div>
                            </a>
                        </li>
                ...
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            ...
                            <li><img src="{{asset('dashboard_assets/images/xs/avatar2.jpg')}}" alt="Avatar"></li>
                            <li><img src="{{asset('dashboard_assets/images/xs/avatar3.jpg')}}" alt="Avatar"></li>
                            <li><img src="{{asset('dashboard_assets/images/xs/avatar4.jpg')}}" alt="Avatar"></li>
                        </ul>
                    </a>
                </div>
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small class="text-muted">Team</small></li>
                            <li><img src="{{asset('dashboard_assets/images/xs/avatar6.jpg')}}" alt="Avatar"></li>
                            <li><img src="{{asset('dashboard_assets/images/xs/avatar7.jpg')}}" alt="Avatar"></li>
                        </ul>
                    </a>
                </div>
                <div class="body">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small class="text-muted">Team</small></li>
                            <li><img src="{{asset('dashboard_assets/images/xs/avatar8.jpg')}}" alt="Avatar"></li>
                            <li><img src="{{asset('dashboard_assets/images/xs/avatar9.jpg')}}" alt="Avatar"></li>
                        </ul>
                    </a>
                </div>
            </div>
            ...
            <ul class="list">
                <li>
                    <div class="user-info m-b-20">
                        <div class="image">
                            <a href="profile.html"><img src="{{asset('dashboard_assets/images/profile_av.jpg')}}" alt="User"></a>
                        </div>
                        <div class="detail">
                            <h6>Admin</h6>
                            <p class="m-b-0">admin@admin.com</p>
                ...
                <li><a href="{{ route('home.post') }}" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>Post Management</span> </a>
                <li><a href="{{ route('home.author') }}" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Authors</span> </a></li>
                <li><a href="{{ route('home.category') }}" class="menu-toggle"><i class="zmdi zmdi-map"></i><span>Categories</span> </a></li>
<!-- 
...
<!-- Jquery Core Js --> 
<script src="{{asset('dashboard_assets/bundles/libscripts.bundle.js')}}"></script> <!-- Lib Scripts Plugin Js --> 
